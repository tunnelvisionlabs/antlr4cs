...
namespace System {
    ...
    [Serializable]
    internal class Tuple<T1> : IStructuralEquatable, IStructuralComparable, IComparable, ITuple {
    ...
    [Serializable]
    internal class Tuple<T1, T2, T3> : IStructuralEquatable, IStructuralComparable, IComparable, ITuple {
    ...
    [Serializable]
    internal class Tuple<T1, T2, T3, T4> : IStructuralEquatable, IStructuralComparable, IComparable, ITuple {
    ...
    [Serializable]
    internal class Tuple<T1, T2, T3, T4, T5> : IStructuralEquatable, IStructuralComparable, IComparable, ITuple {
    ...
    [Serializable]
    internal class Tuple<T1, T2, T3, T4, T5, T6> : IStructuralEquatable, IStructuralComparable, IComparable, ITuple {
    ...
    [Serializable]
    internal class Tuple<T1, T2, T3, T4, T5, T6, T7> : IStructuralEquatable, IStructuralComparable, IComparable, ITuple {
    ...
    [Serializable]
    internal class Tuple<T1, T2, T3, T4, T5, T6, T7, TRest> : IStructuralEquatable, IStructuralComparable, IComparable, ITuple {
